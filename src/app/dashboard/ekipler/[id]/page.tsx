  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-8 items-stretch">
        <div className="bg-white rounded-xl shadow-md border border-[#e3e6f0] p-4 h-full min-h-[120px] flex flex-col justify-between">
        ...
        <div className="bg-white rounded-xl shadow-md border border-[#00a65a]/30 p-4 h-full min-h-[120px] flex flex-col justify-between">
        ...
        <div className="bg-white rounded-xl shadow-md border border-[#f39c12]/30 p-4 h-full min-h-[120px] flex flex-col justify-between">
        ...
        <div className="bg-white rounded-xl shadow-md border border-[#dd4b39]/30 p-4 h-full min-h-[120px] flex flex-col justify-between">
        ...
        <div className="bg-white rounded-xl shadow-md border border-[#00c0ef]/30 p-4 h-full min-h-[120px] flex flex-col justify-between">
        ...
        <div className="bg-white rounded-xl shadow-md border border-[#605ca8]/30 p-4 h-full min-h-[120px] flex flex-col justify-between">
