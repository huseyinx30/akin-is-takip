...
export default function YeniEkipPage() {
    ...
    return (
      <div>
        ...
        <div className="bg-[#00a65a]/10 border border-[#00a65a]/30 rounded-lg p-6 text-[#00a65a] font-medium">
          Davet e-postası gönderildi. Ekip e-postasındaki link ile şifre oluşturup giriş yapabilir.
        </div>
      </div>
    )
  }
  ...
  return (
    <div>
      <div className="mb-6">
        <Link href="/dashboard/ekipler" className="text-[#3c8dbc] hover:underline mb-2 inline-block font-medium">← Ekiplere dön</Link>
        <h1 className="text-2xl font-bold text-[#333]">Yeni Ekip Davet Et</h1>
        <p className="text-[#555] text-sm mt-0.5">Ekip e-posta adresine davet gönderilir. Davet linki ile giriş yapıp şifre oluşturacak.</p>
      </div>
      <div className="bg-white rounded-lg shadow-md border border-[#e3e6f0] p-6">
        <form onSubmit={handleSubmit} className="max-w-2xl space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[#333] mb-1">Ad Soyad / Ekip Adı *</label>
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Link href="/dashboard/ekipler" className="px-6 py-2.5 rounded-lg border border-[#d2d6de] text-[#333] hover:bg-[#f8f9fc] font-medium">İptal</Link>
          </div>
        </form>
        <p className="mt-6 text-[#555] text-sm">Alternatif: Ekip /kayit sayfasından kendisi kayıt olup &quot;Ekip&quot; rolünü seçebilir.</p>
      </div>
    </div>
  )
}
