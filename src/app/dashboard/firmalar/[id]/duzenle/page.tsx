...
export default function FirmaDuzenlePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    router.push(`/dashboard/firmalar/${id}`)
    router.refresh()
  }
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-[#333]">Firma Düzenle</h1>
        <p className="text-[#555] text-sm mt-0.5">Firma bilgilerini güncelleyin</p>
      </div>
