...
interface TamamlananIslerClientProps {
  initialProjects: Project[]
  profiles: Profile[]
}

export function TamamlananIslerClient({ initialProjects, profiles }: TamamlananIslerClientProps) {
          ...
          <button
            ...
            className={`p-4 rounded-xl border-2 text-left transition-all ${
              selectedProjectId === p.id
                ? 'border-[#00a65a] bg-[#00a65a]/5 shadow-md'
                : 'border-[#e3e6f0] bg-white hover:border-[#00a65a]/50'
            }`}
          >
